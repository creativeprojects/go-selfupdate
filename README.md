...
- Tested on Linux, macOS and Windows (using Travis CI)
...
```
$ go get -u github.com/creativeprojects/go-github-selfupdate/cmd/selfupdate-example
```
...
Tests run on Travis CI are run with the token I generated. However, because of security
...
[semver]: https://github.com/blang/semver/v4
...
[GoDoc Badge]: https://godoc.org/github.com/creativeprojects/go-github-selfupdate/selfupdate?status.svg
[GoDoc]: https://godoc.org/github.com/creativeprojects/go-github-selfupdate/selfupdate
[TravisCI Status]: https://travis-ci.org/creativeprojects/go-github-selfupdate.svg?branch=main
[TravisCI]: https://travis-ci.org/creativeprojects/go-github-selfupdate
[Codecov Status]: https://codecov.io/gh/creativeprojects/go-github-selfupdate/branch/main/graph/badge.svg
[Codecov]: https://codecov.io/gh/creativeprojects/go-github-selfupdate
